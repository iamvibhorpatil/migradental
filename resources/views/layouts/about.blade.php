 ...
 <section class="ftco-section ftco-no-pt ftco-no-pb mt-3">
    <div class="container">
        <div class="row no-gutters">
            <div class="col-md-5 col-lg-5 col-sm-12 col-12 p-md-5 img img-2 mt-5 mt-md-0"
                style="background-image: url(assets/images/about.jpg);border-radius: 65px 25px 66px 25px">
            </div>
            <div class="col-md-7 col-lg-7 col-sm-12 col-12 wrap-about py-4 py-md-5 ftco-animate">
                <div class="heading-section mb-5">
                    <div class="pl-md-5 ml-md-5">
                        <span class="subheading mb-2">Welcome to Migradent</span>
                        <h2 class="mb-2" style="font-size: 32px; font-weight:600;color: #333;">Dr. Sarrah Husain
                            Pursues Orofacial Pain Fellowship</h2>
                        <p style="font-size: 18px;">from Roseman University, Smile-USA on 23 Jan 2023</p>
                    </div>
                </div>
                <div class="pl-md-5 ml-md-5 mb-5">
                    <p style="font-size: 16px; line-height: 1.6;">Dr. Sarrah Husain, a Neuromuscular Dentist and
                        Orofacial Pain Specialist, has recently completed a fellowship in Orofacial Pain,
                        Temporomandibular Disorder, and Dental Sleep Medicine from Roseman University, Smile-USA. She is
                        humbled to be the first in Nagpur and among the few in India to pursue this super-specialization
                        after 17 years of her practice as a conservative dentist.</p>
                    <p style="font-size: 16px; line-height: 1.6;">Dr. Sarrah has a passion for helping people suffering
                        from migraines, which she considers the most life-altering pain ever experienced. With a mission
                        to provide a migraine-free life for all, she aims to help 10,000 migraineurs through her
                        expertise and experience.</p>
                    <p style="font-size: 16px; line-height: 1.6;">Moreover, Dr. Sarrah is also on a Bharat Mission
                        #SpitFreeIndia, promoting awareness about oral health and the harmful effects of spitting in
                        public places. It is demeaning and sabotaging our Swachh Bharat Abhiyan. Dr. Sarrah's pursuit of
                        orofacial pain fellowship demonstrates her commitment to providing world-class care and
                        promoting oral health awareness. Her expertise and experience in neuromuscular dentistry,
                        orofacial pain, and temporomandibular disorders make her an asset to the healthcare community.
                        She invites you all to help her on her mission to make India migraine-free and spit-free.</p>
                </div>
                <div class="founder d-flex align-items-center mt-4 pl-md-5">
                    <div class="img" style="background-image: url(assets/images/about.jpg);"></div>
                    <div class="text pl-3">
                        <h3 class="mb-0">Dr. Sarrah Husain</h3>
                        <span class="position" style="font-size: 16px; color: #666;">Neuromuscular Dentist and Orofacial
                            Pain Specialist</span>
                        <hr />
                    </div>
                </div>
            </div>
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb ">
        <div class="container">
            <div class="row no-gutters">
                <div class="col-md-7 wrap-about ftco-animate">
                   <div class="heading-section mb-5">
                    <div class="pr-md-5 mr-md-5">
                        <h2 class="mb-2" style="font-size: 32px; font-weight:600;color: #333;">Dr. Ramsuii Minoii  
                            Pursues Orofacial Pain Fellowship</h2>
                        <p style="font-size: 18px;">from Roseman University, Smile-USA on 23 Jan 2023</p>
                    </div>
                </div>
                    <div class="pr-md-5 mr-md-5 mb-5">
                    <p style="font-size: 16px; line-height: 1.6;">Dr. Ramsuii Minoii, a Neuromuscular Dentist and
                        Orofacial Pain Specialist, has recently completed a fellowship in Orofacial Pain,
                        Temporomandibular Disorder, and Dental Sleep Medicine from Roseman University, Smile-USA. She is
                        humbled to be the first in Nagpur and among the few in India to pursue this super-specialization
                        after 17 years of her practice as a conservative dentist.</p>
                    ...
                    <div class="founder d-flex align-items-center mt-4 pl-md-5">
                        ...
                        <div class="text pr-3">
                            <h3 class="mb-0">Dr. Ramsuii Minoii</h3>
                            <span class="position" style="font-size: 16px; color: #666;">Neuromuscular Dentist and Orofacial
                                Pain Specialist</span>
                            <hr />
                        </div>
                ...
                <div class="shadow col-md-5 p-md-5 img img-2 mt-5 mt-md-0 order-first order-lg-last order-md-last"
                    style="background-image: url(assets/images/about1.jpg);border-radius: 65px 25px 66px 25px">
                </div>
            </div>
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb">
        <div class="container">
            <div class="row no-gutters">
                <div class="shadow col-md-5 p-md-5 img img-2 mt-5 mt-md-0"
                    style="background-image: url(assets/images/about2.jpg);border-radius: 65px 25px 66px 25px">
                </div>
                <div class="col-md-7 wrap-about ftco-animate">
                    <div class="heading-section mb-5">
                        <div class="pl-md-5 ml-md-5 ">
                    ...
                    <div class="founder d-flex align-items-center mt-4 pl-md-5">
                        <div class="img" style="background-image: url(assets/images/about2.jpg);"></div>
                        <div class="text pl-3">
                            <h3 class="mb-0">Dr.xiomi imoix</h3>
                            <span class="position" style="font-size: 16px; color: #666;">Neuromuscular Dentist and Orofacial
                                Pain Specialist</span>
                            <hr />
                        </div>
