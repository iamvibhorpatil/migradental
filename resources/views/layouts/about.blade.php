...
@section('content')
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb ">
        <div class="container">
            <div class="row no-gutters px-4 my-3">
                <div class="col-md-7 wrap-about ftco-animate">
                    <div class="heading-section mb-5">
                        <div class="pr-md-5 mr-md-5">
                            <h2 class="mb-2" style="font-size: 32px; font-weight:600;">Dr. Sarrah Husain Pursues Orofacial
                                Pain Fellowship from Roseman University, Smile-USA on 23 jan 2023</h2>
                        </div>
                    </div>
