...
@section('content')
    <section class="home-slider owl-carousel">
        ...
        <section class="ftco-section ftco-services">
            <div class="card mr-5 ml-5 bg-light border-0">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-3 col-xl-3 py-3">
                            <div class="our-services-box">
                                <div class="our-services speedup">
                                    ...
                                    <h5>Dental Surgeries with laser</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-3 col-xl-3 py-3">
                        ...
                        <div class="col-sm-12 col-md-3 col-xl-3 py-3">
                            <div class="our-services-box">
                                <div class="our-services speedup">
                                    <div class="icon"> <img
                                            src="assets/images/services-img/full-mouth-rehabilation.png">
                                    </div>
                                    <h5>Full Mouth Rehabilation</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12 col-md-3 col-xl-3">
                            <div class="our-services-box">
                                <div class="our-services speedup">
                                    <div class="icon"> <img src="assets/images/services-img/veneers-laminates.png">
                                    </div>
                                    <h5>Veneers & Laminates</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-3 col-xl-3">
                        ...
                        <div class="col-sm-12 col-md-3 col-xl-3 py-3">
                            <div class="our-services-box">
                                <div class="our-services speedup">
                                    ...
                                    <h5>Root Canal Treatment with Laser</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-3 col-xl-3 py-3">
        ...
        <div class="container-fluid" style="background-color:#47b0ab;">
            <div class="row">
                <div class="col-md-7 col-lg-7 col-sm-12 col-request-call-sec-left pl-5">
                    ...
                    <p class="sub-title text-light">Our dental experts are here to help you with any questions or concerns.
                    </p>
                </div>
                    ...
                    <div class=" pl-3 pr-3 pt-4 ">
                        <form>
                            <div class="form-group-rc d-flex">
                                <input type="text" id="name" name="name" class="half-width"
                                    placeholder="Your Name *" required>

                                <input type="tel" id="phone" name="phone" class="half-width"
