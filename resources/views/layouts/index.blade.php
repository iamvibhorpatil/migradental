...
<section class="home-slider owl-carousel">
    <div class="slider-item" style="background-image:url(assets/images/slider-img-1.jpg);"
        data-stellar-background-ratio="0.5"> <div class="overlay"></div> <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true"> <!--
            catchy lines --> </div> </div>
        </div>
                    ...
                    <div class="card-body what-who-sec">
                        ...
                        <div class="pl-md-5 ml-md-5 mb-5">
                            <p>Dr. Sarrah Husain is a distinguished figure in the field of dentistry, with an unwavering
                                ...
                                dedicated practice as a conservative dentist, she has recently taken a significant leap
                                in her
...
<div class="container mb-5 mt-3">
    <div class="row text-center">
        <div class="col-lg-3 col-md-3 col-sm-12 pr-3">
            <div class="icons-land-4">
                <i class="fa-solid fa-heart-pulse" style="color: #47b0ab;"></i>
            </div>
            <div class="counter-wrap">
                 <span class="counter" data-start-number="0" data-end-number="10000" data-speed="900">0</span>
                 <span class="counter_suffix">+</span>
            </div>
            <h6 class="counter_title">SATISFIED PATIENTS</h6>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-12 pr-3">
           <div class="icons-land-4">
           ...
           <div class="counter-wrap">
                 <span class="counter" data-start-number="0" data-end-number="100" data-speed="100">0</span>
                 <span class="counter_suffix">+</span>
            </div>
            <h6 class="counter_title">HEALTH SECTION</h6>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-12 pr-3">
            <div class="icons-land-4"> 
                <i class="fa-solid fa-newspaper" style="color: #47b0ab;"></i>
            </div>
            <div class="counter-wrap">
                 <span class="counter" data-start-number="0" data-end-number="1000" data-speed="1000">0</span>
                 <span class="counter_suffix">+</span>
            </div>
            <h6 class="counter_title">KIND OF RESEARCH</h6>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-12 pr-3">
            <div class="icons-land-4"> 
            ...
            <h6 class="counter_title">AWARD WINNING</h6>
        </div>
        </div>
    </div>
</div>
...
<div class="container-fluid pt-4 pb-3 mt-2" style="background-color:#47b0ab;">
    <!-- <div class="row">
        <div class="col-md-5 col-lg-5 col-sm-12 col-request-call-sec-left pl-5">
            <div class="title">
        ...
        <div class="col-md-7 col-lg-7 col-sm-12 pr-5">
            <div class=" pl-3 pr-3 pt-4 ">
                <form>
                    <div class="form-group-rc d-flex">
                        <div class="row">
                            <div class="col-sm-12 col-md-4 col-lg-4" style="margin-bottom: 10px;">
                                <input type="text" id="name" name="name" class="w-100" placeholder="Your Name *"
                                    required>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4" style="margin-bottom: 10px;">
                                <input type="tel" id="phone" name="phone" class="w-100" placeholder="Mobile No *"
                                    required>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4" style="margin-bottom: 10px;">
                                <button type="submit" class="submit-button w-100">Request a Callback</button>
                            </div>
                        </div>
