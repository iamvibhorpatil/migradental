        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    <h1 class="mb-2 bread">Special Treatment</h1>
                    <p class="breadcrumbs"><span class="mr-2"><a href="{{route('special')}}">Home <i class="fa-solid fa-angle-right" style="color: #ffffff;"></i></a></span> <span>Special Treatment</span></p>
                </div>
            </div>
        </div>
    </section>
